...
export const hoverButtonClass =
	"absolute -bottom-1 left-0 w-0 transition-all h-0.5 bg-black group-hover:w-full";

// adapted from https://pagedone.io/docs/hover-effect
// Button container styles
export const hoverButtonWrapper =
	"relative border border-black group py-1.5 px-2.5 text-black cursor-pointer";

// The animated underline span
export const hoverButtonUnderline =
	"absolute bottom-0 left-0 w-0 h-0.5 bg-black group-hover:w-full group-hover:transition-all cursor-pointer";
