    ...
    return (
        <header className ="text-black font-inter flex flex-row justify-evenly py-15 space-x-10">
            ...
            <div className="flex flex-col items-start box-border h-155 w-100 p-4 rounded-lg bg-gray-50">
                ...
                <span className ="text-left">
                    Delimiters are what separate the prefix and suffix from the name generated by the model. Commas, semicolon, quotes, braces, pipes, slashes, and spaces are the options. For example, using commas a name could be Lakers-lebron-OnFive.
                </span>
            </div>
        </header>
    );
